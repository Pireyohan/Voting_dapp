...
module.exports = {
  ...
  networks: {
    ...
    provider: function(){ 
      return new HDWalletProvider('${process.env.MNEMONIC}', 'URLRPC/${process.env.INFURA_ID}'
      )
    }, 
    ropsten: {
    ...
    Mumbai: {
      provider: function() { return new HDWalletProvider(`${process.env.MNEMONIC}`, `https://polygon-mumbai.infura.io/v3/${process.env.INFURA_ID}` )},
      network_id: 80001
  },
